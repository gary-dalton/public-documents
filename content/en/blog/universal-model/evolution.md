...
show_comments: false
draft: false
tags: ["universal-model", "evolution"]
categories: ["thoughts"]
---
...
| :--- | :--- | :--- | :--- |
| **Generation & Inheritance** | Objects generate offspring with inherited properties. | Forking a codebase. | Objects, Relationships, Forces |
| **Genomic Survival** | The informational pattern persists, not the carrier. | TCP/IP outlasts hardware. | Information & Thermodynamics |
| **Mutation** | Variation in the inheritance channel (stochastic or directed). | Manuscript copying; CRISPR. | Stochasticity, Agency |
| **Adaptive / Maladaptive** | Fitness is relative to context, not intrinsic. | Fur coat in arctic vs. tropics. | Context, Phase Changes |
| **Epigenetic Inheritance** | Lifetime deformation transmitted to descendants. | War generation's risk-aversion. | State-Based Memory, Context |
| **Evolution as Emergence** | Population-level dynamics from local interactions. | No ant understands the colony. | Emergence |
