...
linkTitle: "Eval Proposals"
description: "As of November 2025, a number of data center proposals have been made for SE Wisconsin. How should we consider these?"
author: Gary Dalton
resources:
- src: ""
  title: ""
...
categories: ["policy"]
date: 2025-11-13
aliases: ["/local/economy/datacenters/evaluating-proposals/"]
expiryDate: ""
layout: ""
include_toc: false
show_comments: false
...
2. [Statewide Context](#statewide-context)
3. [Risk Scoring Matrix](#risk-scoring-matrix)
4. [Project Analyses](#project-analyses)
   * [Microsoft — Mount Pleasant](#1-microsoft--mount-pleasant)
   * [Microsoft — Racine/Caledonia Future Site](#2-microsoft--racinecaledonia-future-site)
   * [Vantage + OpenAI + Oracle — Port Washington (“Stargate”)](#3-vantage--openai--oracle--port-washington-stargate)
   * [Meta — Beaver Dam](#4-meta--beaver-dam)
5. [Cross-Project Findings](#cross-project-findings)
6. [Recommendations for Wisconsin](#recommendations-for-wisconsin)
7. [Appendix A — Policy Questions](#appendix-a--policy-questions)
8. [Appendix B — Glossary](#appendix-b--glossary)
9. [Reference Table - Wisconsin Data Center Landscape](#ref-table)
...
3. **A Wisconsin AI Governance & Safety Institute**
...
4. **Workforce and Apprenticeship Pipelines**
...
5. **Transparent, statewide standards** for cooling, water use, grid impact modeling, incentive caps, and environmental reporting.
...
The choice is not whether Wisconsin will change, but **how** and **to whose benefit**.
This moment will not return.
But if approached strategically, it can define the state’s trajectory for generations.
...
See the addittional documents, [Community Technology Partnership Opportunities for Wisconsin](/policy/datacenters/benefits-brief.md) and [Wisconsin AI Governance](/policy/datacenters/wi-ai-governance.md).

---

### 1. Establish a Statewide Data Center Regulatory Framework

Wisconsin needs consistent, predictable standards that apply to all hyperscale development.
This should include:
...
Data centers offer modest but high-quality operations jobs, and substantial construction work.
Wisconsin should require participating companies to:
...
**[Policy Questions - Wisconsin Data Center Projects](/policy/datacenters/policy-questions.md)**
...
## **Reference Table - Wisconsin Data Center Landscape** {#ref-table}
